...
Ниже представлены 12 тем выпускных квалификационных (дипломных) работ, распределенных между членами команды разработчиков, с индивидуальным техническим заданием (ТЗ) для каждого студента.
